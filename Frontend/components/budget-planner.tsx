    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">KSh {monthlyBudget.toFixed(2)}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">KSh {currentSpending.toFixed(2)}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">KSh {remainingBudget > 0 ? remainingBudget.toFixed(2) : "0.00"}</div>
      ...
      {budgetUsed > 90 && (
        <Alert className={budgetUsed > 100 ? "border-red-200 bg-red-50" : "border-orange-200 bg-orange-50"}>
          ...
          <AlertDescription className={budgetUsed > 100 ? "text-red-800" : "text-orange-800"}>
            {budgetUsed > 100
              ? `You're over budget by KSh ${(currentSpending - monthlyBudget).toFixed(2)}. Consider canceling some subscriptions.`
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="space-y-2">
            <Label htmlFor="budget">Monthly Budget (KSh)</Label>
          ...
          <div className="space-y-2">
            <Label>Savings Goal: KSh {savingsGoal}/month</Label>
            <Slider
              value={[savingsGoal]}
          ...
          <div className="p-4 bg-muted rounded-lg">
            ...
            <div className="flex justify-between text-sm">
              <span>Used: KSh {currentSpending.toFixed(2)}</span>
              <span>Budget: KSh {monthlyBudget.toFixed(2)}</span>
            </div>
          </div>
        </CardContent>
      </Card>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-sm text-muted-foreground">
                        KSh {spent.toFixed(2)} / KSh {budget.toFixed(2)}
                      </span>
              ...
              {potentialSavings >= savingsGoal && (
                <div className="p-4 border rounded-lg bg-green-50">
                  ...
                  <p className="text-sm text-green-700">
                    Great! You have KSh {potentialSavings.toFixed(2)} remaining in your budget, which exceeds your savings
                    goal of KSh {savingsGoal}.
                  </p>
                </div>
              )}
            </div>
