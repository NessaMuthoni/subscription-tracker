    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">KSh {yearEndPrediction.toFixed(2)}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">KSh {totalYearPrediction.toFixed(2)}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">KSh {totalOptimizationSavings.toFixed(2)}</div>
        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
            ...
            <p className="text-sm text-green-700">
              ...
              <strong>KSh {totalOptimizationSavings.toFixed(2)}/month</strong> or{" "}
              <strong>KSh {(totalOptimizationSavings * 12).toFixed(2)}/year</strong>.
            </p>
          </div>
        </CardContent>
      </Card>
