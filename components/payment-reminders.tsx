      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              ${todayPayments.reduce((sum, p) => sum + p.cost, 0).toFixed(2)} total
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              ${nextWeekPayments.reduce((sum, p) => sum + p.cost, 0).toFixed(2)} total
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">${totalUpcomingAmount.toFixed(2)}</div>
                ...
                <div key={payment.id} className="flex items-center justify-between p-4 border rounded-lg">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-right">
                      <div className="font-bold">${payment.cost.toFixed(2)}</div>
